...
export const QUESTIONS_FR = {
  ...
  p14: { q: 'Quel athlète mauricien de sprint, plusieurs fois médaillé aux Jeux du Commonwealth, porta le drapeau national aux Jeux olympiques de Pékin en 2008\u00a0?', options: ['Stephan Buckland', 'Bruno Julie', 'Karen Foo Kune', 'Eric Milazar'] },
  ...
  s16: { q: 'Dans quelle discipline de l\u2019athlétisme le porte-drapeau Stephan Buckland concourait-il, remportant plusieurs médailles aux Jeux du Commonwealth pour l\u2019île Maurice\u00a0?', options: ['L\u2019athlétisme', 'La boxe', 'Le tir à l\u2019arc', 'La voile'] },
